          ...
          {posts
            ...
            .map((post) => (
              <Link href={`/blog/${post.id}`} key={post.id}>
                <div className="featured-post bg-white rounded-3xl overflow-hidden shadow-2xl border border-gray-100 group cursor-pointer flex flex-col md:flex-row h-full md:h-[500px]">
                  {/* Image Side */}
                  ...
                  <div className="md:w-1/2 p-8 md:p-16 flex flex-col justify-center relative">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0e1d34] mb-4 leading-tight group-hover:text-primary transition-colors">
                      {post.title}
                    </h2>
                    <p className="text-gray-600 text-lg mb-8 line-clamp-3">
                      {post.excerpt}
                    </p>
                    <div className="mt-auto flex items-center text-[#0e1d34] font-bold group-hover:translate-x-2 transition-transform">
                      Read Full Article{" "}
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <div className="flex gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-6 py-4 rounded-full border-none focus:ring-2 focus:ring-[#0e1d34]"
                />
                <Button className="rounded-full px-8 py-6 bg-[#0e1d34] text-white hover:bg-black">
                  Subscribe
                </Button>
              </div>
            </div>
